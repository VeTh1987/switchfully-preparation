CREATE SCHEMA multiplejoins;

CREATE TABLE students (id INTEGER AUTO_INCREMENT PRIMARY KEY,
    first_name TEXT,
    last_name TEXT,
    email TEXT,
    phone TEXT,
...
CREATE TABLE student_projects (id INTEGER AUTO_INCREMENT PRIMARY KEY,
    student_id INTEGER,
    title TEXT);
...
CREATE TABLE project_pairs (id INTEGER AUTO_INCREMENT PRIMARY KEY,
    project1_id INTEGER,
    project2_id INTEGER);
